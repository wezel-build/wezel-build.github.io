...
[exec is one such binary](https://github.com/wezel-build/executor_exec). [So is filesize](https://github.com/wezel-build/executor_filesize/). Each one does what it says on the tin and hands the result back.
